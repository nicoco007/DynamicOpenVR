    ...
    internal class Plugin
    {
        ...
        private void RegisterActionSet()
        {
            ...
            unityXRActions = new UnityXRActions
            {
                ...
                {
                    system = new BooleanInput("/actions/unity/in/left_system_button"),
                    systemTouched = new BooleanInput("/actions/unity/in/left_system_touch"),
                    select = new BooleanInput("/actions/unity/in/left_select_button"),
                    menu = new BooleanInput("/actions/unity/in/left_menu_button"),
                    primaryButton = new BooleanInput("/actions/unity/in/left_primary_button"),
                    primaryTouched = new BooleanInput("/actions/unity/in/left_primary_touch"),
                    secondaryButton = new BooleanInput("/actions/unity/in/left_secondary_button"),
                    secondaryTouched = new BooleanInput("/actions/unity/in/left_secondary_touch"),
                    grip = new VectorInput("/actions/unity/in/left_grip"),
                    gripPressed = new BooleanInput("/actions/unity/in/left_grip_button"),
                    gripForce = new VectorInput("/actions/unity/in/left_grip_force"),
                    trigger = new VectorInput("/actions/unity/in/left_trigger"),
                    triggerPressed = new BooleanInput("/actions/unity/in/left_trigger_button"),
                    triggerTouched = new BooleanInput("/actions/unity/in/left_trigger_touch"),
                    thumbstick = new Vector2Input("/actions/unity/in/left_primary_2d_axis"),
                    thumbstickClicked = new BooleanInput("/actions/unity/in/left_primary_2d_axis_click"),
                    thumbstickTouched = new BooleanInput("/actions/unity/in/left_primary_2d_axis_touch"),
                    trackpad = new Vector2Input("/actions/unity/in/left_secondary_2d_axis"),
                    trackpadClicked = new BooleanInput("/actions/unity/in/left_secondary_2d_axis_click"),
                    trackpadTouched = new BooleanInput("/actions/unity/in/left_secondary_2d_axis_touch"),
                    trackpadForce = new VectorInput("/actions/unity/in/left_secondary_2d_axis_force"),
                    devicePose = new PoseInput("/actions/unity/in/left_grip_pose"),
                    pointer = new PoseInput("/actions/unity/in/left_aim_pose"),
                ...
                {
                    system = new BooleanInput("/actions/unity/in/right_system_button"),
                    systemTouched = new BooleanInput("/actions/unity/in/right_system_touch"),
                    select = new BooleanInput("/actions/unity/in/right_select_button"),
                    menu = new BooleanInput("/actions/unity/in/right_menu_button"),
                    primaryButton = new BooleanInput("/actions/unity/in/right_primary_button"),
                    primaryTouched = new BooleanInput("/actions/unity/in/right_primary_touch"),
                    secondaryButton = new BooleanInput("/actions/unity/in/right_secondary_button"),
                    secondaryTouched = new BooleanInput("/actions/unity/in/right_secondary_touch"),
                    grip = new VectorInput("/actions/unity/in/right_grip"),
                    gripPressed = new BooleanInput("/actions/unity/in/right_grip_button"),
                    gripForce = new VectorInput("/actions/unity/in/right_grip_force"),
                    trigger = new VectorInput("/actions/unity/in/right_trigger"),
                    triggerPressed = new BooleanInput("/actions/unity/in/right_trigger_button"),
                    triggerTouched = new BooleanInput("/actions/unity/in/right_trigger_touch"),
                    thumbstick = new Vector2Input("/actions/unity/in/right_primary_2d_axis"),
                    thumbstickClicked = new BooleanInput("/actions/unity/in/right_primary_2d_axis_click"),
                    thumbstickTouched = new BooleanInput("/actions/unity/in/right_primary_2d_axis_touch"),
                    trackpad = new Vector2Input("/actions/unity/in/right_secondary_2d_axis"),
                    trackpadClicked = new BooleanInput("/actions/unity/in/right_secondary_2d_axis_click"),
                    trackpadTouched = new BooleanInput("/actions/unity/in/right_secondary_2d_axis_touch"),
                    trackpadForce = new VectorInput("/actions/unity/in/right_secondary_2d_axis_force"),
                    devicePose = new PoseInput("/actions/unity/in/right_grip_pose"),
                    pointer = new PoseInput("/actions/unity/in/right_aim_pose"),
